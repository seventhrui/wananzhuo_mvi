package com.seventh.demo.widget.decoration
...
import com.seventh.demo.extension.dp2px
...
internal class MySectionDecoration(
    ...
    override fun onDrawOver(
        ...
        //获取该位置的标题名称
        groupTitleName = titleDataList[position].name
        ...
        //---------------这里实现了上升和下拉平滑的效果--------------------
        //下一个item的名字
        val nextGroupTitleName = titleDataList[position + 1].name
