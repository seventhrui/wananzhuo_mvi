...
class QMUICenterGravityRefreshOffsetCalculator : QMUIPullRefreshLayout.RefreshOffsetCalculator {
    ...
    override fun calculateRefreshOffset(
        ...
        return if (targetCurrentOffset < refreshViewHeight) {
            targetCurrentOffset - refreshViewHeight
        } else (targetCurrentOffset - refreshViewHeight) / 2
    }
}
